...
public class MainActivity extends AppCompatActivity
    ...
    public static LocationRecorder locationRecorder;
    ...
    @Override
    public boolean onNavigationItemSelected(MenuItem aItem) {
    ...
    private void setStatisticsFragmentOnApplicationStart()
    {
    ...
    private void setFragment(Fragment aFragment)
    {
        ...
        ft.replace(R.id.content_frame, aFragment);
        ft.commit();
    }
}
