...
public class LastWeek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Graph.drawDistanceGraph(7, graph, this);
    }
    ...
    private void distance() {
        distanceButt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Graph.drawDistanceGraph(7, graph, LastWeek.this);
            }
        });
    }
    ...
    private void weight() {
        weightButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Graph.drawWeightGraph(7, graph, LastWeek.this);
            }
        });
    }
    ...
    private void back(){
        backButt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LastWeek.this, MainActivity.class);
                startActivity(i);
            }
        });
    }
